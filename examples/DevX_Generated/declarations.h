...
static DX_TIMER_BINDING *timer_bindings[] = {  &tmr_AzureIotConnectedLed, &tmr_ButtonA, &tmr_MeasureTemperature, &tmr_PublishTelemetry, &tmr_Watchdog };
...
static DX_DEVICE_TWIN_BINDING* device_twin_bindings[] = {  &dt_DesiredMeasurementRate, &dt_DesiredTemperature };
